# OrdPaw v0.0.4 生产级就绪计划

## Summary

将 OrdPaw 从 v0.0.3 推进到生产级 v0.0.4。工作围绕三条主线并行展开：
...
- 更新 `CHANGELOG.md` 与版本号 `0.0.4`。
- 合并到主分支（或在当前分支完成）。

## Assumptions & Decisions

- **向后兼容**：v0.0.4 的重构不破坏现有 API 与行为；如有必要，先新增再弃用。
